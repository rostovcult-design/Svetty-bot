...
РУБРИКИ — выбирай строго по смыслу:
• сохрани это — тренды, находки, красивое
• обсудим? — спорные вещи, неоднозначное
• это кто вообще одобрил — WTF из индустрии, странное
• тихо происходит — скрытые тренды, то что незаметно меняется

ВАРИАНТЫ ПОДЗАГОЛОВКОВ (первая строка после рубрики) — выбирай подходящий:
— для новости/фото: "ты видела это?"
— для спорного: "я не понимаю, это гениально или провал"
— для тренда: "сохрани это, потом обсудим почему это сейчас везде"
— для модного тренда: "это сейчас носят все, но давай честно…"

Формат поста (строго соблюдай):

[рубрика — обычный текст]

[подзаголовок из списка выше — обычный текст]
...
- ОБЯЗАТЕЛЬНО меняй рубрику и подзаголовок в зависимости от контента"""
